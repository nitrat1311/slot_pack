...
class AppColors {
  ...
  static const frontColor = Color.fromARGB(255, 107, 185, 240); //any colors
  static const buttonColor = Color.fromRGBO(143, 136, 225, 0.678);
  ...
  static const double scoreY = randomPadding * 5;
